...
@REM git push -f https://github.com/Shuaiwen-Cui/ESP_PRACTICE.git main
git push -f https://github.com/Shuaiwen-Cui/ESP_PRACTICE.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/ESP_PRACTICE.git
